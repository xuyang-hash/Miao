...
import com.meowing.loud.arms.base.delegate.FragmentDelegate;
import com.meowing.loud.arms.base.delegate.FragmentDelegateImpl;
...
public class FragmentLifecycle extends FragmentManager.FragmentLifecycleCallbacks {
    ...
    public void onFragmentActivityCreated(@NonNull FragmentManager fm, @NonNull Fragment f, Bundle savedInstanceState) {
        FragmentDelegate fragmentDelegate = fetchFragmentDelegate(f);
        if (fragmentDelegate != null) { fragmentDelegate.onActivityCreate(savedInstanceState);
        }
    }
